...
if __name__ == "__main__":
    ...
    actions_a_range = (5, 7)
    actions_a_wrong_range_0 = (0, 5)
    actions_a_wrong_range_1 = (7, 10)
    ...
    # Just positive rewards
    xp = xp[past_rewards==positive_reward,:]
    yp = yp[past_rewards==positive_reward]

    # # Just negative rewards
    # xp = xp[past_rewards==negative_reward,:]
    # yp = yp[past_rewards==negative_reward]
...
final_results = []
for positive_reward_context in positive_reward_contexts:
