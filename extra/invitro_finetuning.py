...
if __name__ == "__main__":
    ...
    if output_quadratic:
        ...
        var = 'LIN'
    exp_cluster = f"TE-{train_every:,}_LR-{str(lr).split('.')[-1]}_EPOCH-{num_epochs}_LFT-{loss_function_type}_SS-{sample_size}_ALPHA-{str(alpha).split('.')[-1]}_{var}"
